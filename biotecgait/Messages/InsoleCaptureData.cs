...
namespace biotecgait.Messages
{
    public class InsoleCaptureData
    {
        ...
        public InsoleCaptureData(WisewalkSDK.WisewalkData data, int index)
        {
        ...
        public InsoleCaptureData(WisewalkSDK.SoleSensor sole)
        {
            raw[Sensor.Hallux] = sole.hallux;
            raw[Sensor.Toes] = sole.toes;
            raw[Sensor.Met1] = sole.met_1;
        ...
        public InsoleCaptureData(Random random, byte handler)
        {
